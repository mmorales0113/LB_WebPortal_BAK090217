...
using WebPortal.Authorization.Accounts;
using WebPortal.Authorization.Accounts.Dto;
using WebPortal.Authorization.Impersonation;
...
using WebPortal.Web.Models.Account;
using WebPortal.Security;
using WebPortal.Security.Recaptcha;
using WebPortal.Sessions;
using WebPortal.Url;
using WebPortal.Web.IdentityServer;
using WebPortal.Web.Security.Recaptcha;
using WebPortal.Web.Session;
using WebPortal.Web.Views.Shared.Components.TenantChange;
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            try
            {
                ...
                if (model.IsExternalLogin)
                {
                    ...
                    {
                        throw new Exception("Cannot external login!");
                    }
