...
using WebPortal.Web.Authentication.JwtBearer;
using WebPortal.Web.Authentication.TwoFactor;
using WebPortal.Web.Configuration;
#if FEATURE_SIGNALR
...
namespace WebPortal.Web
{
    ...
    public class WebPortalWebCoreModule : AbpModule
    {
        ...
        public WebPortalWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        private void SetAppFolders()
        {
            ...
            {
                var currentAssemblyDirectoryPath = typeof(WebPortalWebCoreModule).GetAssembly().GetDirectoryPathOrNull();
