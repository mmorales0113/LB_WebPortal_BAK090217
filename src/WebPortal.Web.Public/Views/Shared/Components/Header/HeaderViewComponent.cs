...
using WebPortal.Url;
using WebPortal.Web.Public.Startup;
using WebPortal.Web.Session;

namespace WebPortal.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : WebPortalViewComponent
    {
