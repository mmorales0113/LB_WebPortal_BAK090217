...
namespace WebPortal.Web.Public.Startup
{
    ...
    public class WebPortalWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public WebPortalWebFrontEndModule(IHostingEnvironment env, WebPortalEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(WebPortalWebFrontEndModule).GetAssembly());
        }
    }
}
