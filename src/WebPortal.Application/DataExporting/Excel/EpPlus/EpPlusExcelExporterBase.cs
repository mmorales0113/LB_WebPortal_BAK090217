...
using WebPortal.Dto;
using WebPortal.Net.MimeTypes;
using OfficeOpenXml;

namespace WebPortal.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : WebPortalServiceBase, ITransientDependency
    {
