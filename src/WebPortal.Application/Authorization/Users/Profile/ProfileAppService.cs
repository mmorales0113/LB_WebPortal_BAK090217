...
using WebPortal.Authorization.Users.Profile.Cache;
using WebPortal.Authorization.Users.Profile.Dto;
using WebPortal.Friendships;
using WebPortal.Identity;
using WebPortal.Security;
using WebPortal.Storage;
using WebPortal.Timing;

namespace WebPortal.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : WebPortalAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("WebPortal",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("WebPortal",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
