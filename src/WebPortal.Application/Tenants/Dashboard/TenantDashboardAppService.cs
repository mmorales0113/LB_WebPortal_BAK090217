...
using WebPortal.Tenants.Dashboard.Dto;

namespace WebPortal.Tenants.Dashboard
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Tenant_Dashboard)]
    public class TenantDashboardAppService : WebPortalAppServiceBase, ITenantDashboardAppService
    {
